package aufgabe4.spiel.util;/* Eine schrecklich verschachtelte Klasse zur einfachen Darstellung
 ...
 * aufgabe4.spiel.util.Interaktionsbrett &uuml;bergeben, k&ouml;nnen mit der
 ...
 * vom aufgabe4.spiel.util.Interaktionsbrett bei einer Mausaktion aufgerufen
 * werden.
 * <ul>
 * <li>
 ...
 * </ul>
 * 
 * Objekte k&ouml;nnen dem aufgabe4.spiel.util.Interaktionsbrett mitteilen, dass
...
public class Interaktionsbrett {
  ...
  public Interaktionsbrett() {
    ...
    javax.swing.SwingUtilities.invokeLater(new Runnable() {
      // @Override
      public void run() {
        rahmen = new JFrame("aufgabe4.spiel.util.Interaktionsbrett");
        rahmen.add(brett);
   ...
   * der Klasse aufgabe4.spiel.util.Interaktionsbrett </a> gezeigt wird.
   * 
   * @param quelle
   ...
   * aufgabe4.spiel.util.Interaktionsbrett </a> gezeigt wird.
   * 
   * @param quelle
   *          Objekt, das informiert werden soll, falls
   ...
   * werden, wie es in der <a href="#Nutzung"> Beschreibung
   * der Klasse aufgabe4.spiel.util.Interaktionsbrett </a> gezeigt wird. Der als
  ...
  /**
   * Objekte k&ouml;nnen an ein aufgabe4.spiel.util.Interaktionsbrett so
   ...
   *          wenn im aufgabe4.spiel.util.Interaktionsbrett eine Taste
   *          gedr&uuml;ckt wurde
   */
